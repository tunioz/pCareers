  ...
  transaction(() => {
    ...
    for (const post of posts) {
      ...
      const coverImages: Record<string, string> = {
        ...
        'Global PPC: Driving Growth Across 130+ Countries': 'https://images.unsplash.com/photo-1460925895917-afdab827c52f?w=1080&fit=crop',
    ...
    const jobs = [
      ...
      // 6. Senior QA Engineer -- Desktop Applications
      {
        ...
        team_quote: 'Quality at pCloud means 99.9% uptime for 22M+ users. We are the last line of defence before every release.',
      ...
      // 7. PPC Specialist
      {
        ...
        is_new: 0,
        is_high_priority: 0,
        description: 'Global campaigns. Real budgets. Direct impact on growth for 22M+ users across 130+ countries.\n\npCloud serves 22 million users across 130+ countries. We did not get here by accident. Behind that growth is a performance marketing engine that runs campaigns across Meta, Google, Microsoft, and emerging platforms -- in multiple languages, multiple markets, simultaneously.\n\nWe need a PPC Specialist who does not just execute tasks. We need someone who takes ownership of platforms and campaigns, analyses performance obsessively, and proposes ideas that move the needle. Someone who thinks in ROAS, CPL, and conversion rates, but also understands that behind every click is a person deciding whether to trust us with their data.',
      ...
      // 8. Content Marketing Specialist
      {
        ...
        is_new: 0,
        is_high_priority: 0,
        description: 'Words that drive growth. Content strategy for a product used by 22M+ people in 130+ countries.\n\nAt pCloud, content is not filler. It is a growth engine. Our blog, social media, email campaigns, and website content reach millions of people across 130+ countries. Every piece of content we publish either helps someone discover pCloud, understand why it matters, or decide to trust us with their data.\n\nWe need a Content Marketing Specialist who can craft compelling copy, develop data-informed strategies, and manage multi-channel content across international markets. Someone who understands SEO, knows how to write for humans (not just algorithms), and takes ownership of performance.',
      ...
      // 9. Marketing Specialist with [Language]
      {
        ...
        team_lead: 'Daniela Ivanova, Head of Marketing',
        team_quote: 'pCloud serves 130+ countries. Every market deserves campaigns that feel local, not translated. That is your job.',
    ...
    const teamMembers = [
      ...
      },
      {
        ...
        role: 'QA Lead',
        bio: 'Ivaylo leads the Quality Engineering Team, ensuring 99.9% uptime for 22M+ users across all desktop platforms.',
        department: 'Quality Assurance',
        sort_order: 5,
      },
      {
        ...
        bio: 'Daniela leads all marketing efforts at pCloud -- from performance marketing and content strategy to regional growth across 130+ countries.',
        department: 'Marketing',
        sort_order: 6,
      },
      {
    ...
    const settings = [
      ...
      { key: 'company_description', value: 'pCloud is a Swiss-based cloud storage platform trusted by 22 million users across 130+ countries. We store over 500 petabytes of data with 99.9% uptime -- and we have been doing it for over 10 years.' },
    ...
    const defaultBenefits = [
      { title: 'Remote Flexibility', description: 'Work from anywhere with flexible hours. One sync week per month in the Sofia office. We trust outcomes, not hours.', sort_order: 0 },
      { title: 'Health & Wellness', description: 'Comprehensive health insurance with dental. Gym membership. Mental health support. Because you can\'t build great products if you\'re not well.', sort_order: 1 },
      { title: 'Learning Budget', description: 'Annual budget for conferences, courses, books, certifications. Your growth is our investment -- and we mean it.', sort_order: 2 },
      { title: 'Stock Options', description: 'Equity participation. You build the product, you share the upside.', sort_order: 3 },
      { title: 'Team & Culture', description: 'Regular team events, hackathons, knowledge-sharing sessions. An engineering culture that celebrates craft, not politics.', sort_order: 4 },
      { title: 'PTO & Sabbatical', description: '20 + 5 days paid leave. Sabbatical option after 5 years. Rest is not a reward -- it is a requirement.', sort_order: 5 },
    ];
